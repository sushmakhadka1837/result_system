    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            ...
            <select id="semester_id" class="form-control">
                ...
                <?php for($s=1;$s<=8;$s++): ?>
                    <option value="<?= $s; ?>" <?php if($sem_id==$s) echo 'selected'; ?>><?= $s; ?> Semester</option>
                <?php endfor; ?>
            </select>
        </div>
    </div>
...
?>
    <div class="col-md-4">
        <a href="teacher_upload_pdf.php?subject_id=<?= $sub['id']; ?>" style="text-decoration:none;color:inherit;">
