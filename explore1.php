...
<body>
 <div class="top-header d-flex flex-wrap justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center">
      <img src="images.png" alt="PEC Logo">
      <div class="ms-3">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="mainNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="#">B.E. Computer</a></li>
              <li><a class="dropdown-item" href="#">B.E. Civil</a></li>
              <li><a class="dropdown-item" href="#">B.E. Electrical</a></li>
            </ul>
          </li>
        ...
        <a class="btn btn-registration" href="#">Registration</a>
      </div>
    </div>
  </nav>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text fs-5">
            Gandaki University का कुलपति <strong>Prof. Dr. Ganesh Man Gurung</strong> ज्यूबाट <strong>8th PEC Tech EXPO 2022</strong> को उदघाटन।
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4">
      <div class="sidebar mt-4 mt-lg-0">
        ...
        <div class="bottom-section">
          ...
          <div class="mb-4 text-center">
            <a href="images/expo.jpg" class="glightbox" data-gallery="bottom-gallery">
              <img src="images/expo.jpg" class="img-fluid" alt="Clubs" />
            </a>
            <p class="mt-2">8th PEC EXPO</p>
          </div>
        </div>
      </div>
    </div>
