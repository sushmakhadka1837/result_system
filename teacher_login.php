...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if(!$teacher) $error="Email not registered.";
    elseif($teacher['is_verified']==0) $error="Email not verified.";
    elseif(!password_verify($password,$teacher['password'])) $error="Invalid password.";
    else{
...
<p style="font-size:12px; margin-top:8px;">Forgot password? <a href="teacher_forgot_password.php">Click here</a></p>
<p style="font-size:12px; margin-top:8px;">No account? <a href="teacher_signup.php">Signup</a></p>
</div>
</body>
</html>
